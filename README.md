<div align="center">
  ...
  <p>
    ...
    <img alt="Regression tests: 232" src="https://img.shields.io/badge/tests-232-3b6ea8">
...
| Regression tests | `232` | Unit and workflow tests run before publishing the current page. |
