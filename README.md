<div align="center">
  ...
  <p>
    ...
    <img alt="Regression tests: 216" src="https://img.shields.io/badge/tests-216-3b6ea8">
...
| Regression tests | `216` | Unit and workflow tests run before publishing the current page. |
