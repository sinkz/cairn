<div align="center">
  ...
  <p>
    ...
    <img alt="Regression tests: 228" src="https://img.shields.io/badge/tests-228-3b6ea8">
...
| Regression tests | `228` | Unit and workflow tests run before publishing the current page. |
