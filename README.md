<div align="center">
  ...
  <p>
    ...
    <img alt="Regression tests: 205" src="https://img.shields.io/badge/tests-205-3b6ea8">
...
| Regression tests | `205` | Unit and workflow tests run before publishing the current page. |
