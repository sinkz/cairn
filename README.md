<div align="center">
  ...
  <p>
    ...
    <img alt="Regression tests: 164" src="https://img.shields.io/badge/tests-164-3b6ea8">
...
| Regression tests | `164` | Unit and workflow tests run before publishing the current page. |
