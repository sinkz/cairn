<div align="center">
  ...
  <p>
    ...
    <img alt="Testes de regressão: 232" src="https://img.shields.io/badge/testes-232-3b6ea8">
...
| Testes de regressão | `232` | Testes unitários e de workflow rodados antes da publicação atual. |
