<div align="center">
  ...
  <p>
    ...
    <img alt="Testes de regressão: 216" src="https://img.shields.io/badge/testes-216-3b6ea8">
...
| Testes de regressão | `216` | Testes unitários e de workflow rodados antes da publicação atual. |
...
python bench/publish_metrics.py --output docs/data/benchmarks.json --tests 216
```
