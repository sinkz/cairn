<div align="center">
  ...
  <p>
    ...
    <img alt="Testes de regressão: 228" src="https://img.shields.io/badge/testes-228-3b6ea8">
...
| Testes de regressão | `228` | Testes unitários e de workflow rodados antes da publicação atual. |
